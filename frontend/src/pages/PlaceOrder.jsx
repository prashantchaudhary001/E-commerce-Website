    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-5 sm:pt-14 min-h-[80vh] border-t'>
     {/* -----------left side------------ */}
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <input required onChange={onChangeHandeler} name='email' value={formData.email}  className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='email address' />
        <input required onChange={onChangeHandeler} name='street' value={formData.street}  className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='street' />
        <div className='flex gap-3'>
        ...
        <input required onChange={onChangeHandeler} name='phone' value={formData.phone}  className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="number" placeholder='Number' />
      </div>
